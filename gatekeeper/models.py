...
class RoutePolicy(Base):
    ...
    __table_args__ = (UniqueConstraint("module", "route", name="uq_route_policy_module_route"),)
...
class AuditLog(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"<AuditLog id={self.id} {self.method} {self.module}.{self.route} {self.status_code}>"
        )
